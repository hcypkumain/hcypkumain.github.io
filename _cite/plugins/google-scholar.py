...
def main(entry):
    ...
    if not api_key:
        logger.warning("No GOOGLE_SCHOLAR_API_KEY found in environment variables. Skipping Google Scholar API.")
        return []
    ...
    params = {
        ...
        "api_key": api_key,
        "num": 100,  # max allowed
        "as_ylo": 2019,  # Get papers from 2019 onwards
        "as_yhi": 2025,  # Get papers up to 2024
    }
    ...
    def query(_id):
        ...
        return get_safe(serpapi.search(params), "articles", [])
